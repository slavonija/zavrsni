...
// Dodaj na kraj matrice dvije nove voćke korištenjem uglatih zagrada i ugrađene php array funkcije
...
// dodavanje elemenata matrice na kraj matrice
$fruits[] = "ananas";
// dodavanje elemenata matrice na određeno mjesto
...
print_r($fruits);     // ispisuje ljepše
 ...
 var_dump($fruits == false); // prazan niz je false a ovaj nije prazan

// brisanje elementa matrice
unset($fruits[0]);      // ukloni jabuke iz matrice ali ostavi rupu
array_shift($fruits);   // izbaci banane i reindeksira sve elemente, dakle kreće od 0
...
$prvi = [2,3,7];
$drugi = [2,5,9];
$spojeniNiz = array_merge($prvi, $drugi); // [2,3,7,2,5,9]
...
$spojeniNiz = [...$prvi,...$drugi];   // radi dekompoziciju 2D na članove [2,3,7,2,5,9]
print_r($spojeniNiz);
